		...
		engBtn.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				if(engBtn.isSelected()) {
					GameManagement.pathName = "wordType/words.txt";
				}
			}
		});
		hangeulBtn.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				if(hangeulBtn.isSelected()) {
					GameManagement.pathName = "wordType/koreanWord.txt";
				}
			}
		});
